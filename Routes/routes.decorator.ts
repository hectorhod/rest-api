...
import { Api, servers } from '../RestController/RestController';
import { CommonRoutes } from './CommonRoutes';
import { METHOD } from './method.enum';
import 'reflect-metadata'
import { MetadataKeys } from './controller.decorator';

export function routeConfig (method:METHOD, route:string, root?:boolean): MethodDecorator {
    ...
    return function(
        ...
        routers.push({method,path:route, handlerName:propertyKey, rootPath:root})
