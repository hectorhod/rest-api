...
export abstract class CommonRoutes {
    ...
    protected get(req:Request, res:Response){throw new Error("O Método não foi implementado!!")};
    protected post(req:Request, res:Response){throw new Error("O Método não foi implementado!!")};
    protected put(req:Request, res:Response){throw new Error("O Método não foi implementado!!")};
    protected delete(req:Request, res:Response){throw new Error("O Método não foi implementado!!")};
