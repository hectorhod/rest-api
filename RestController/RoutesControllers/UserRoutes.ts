...
export abstract class UserRoutes extends CommonRoutes{
    ...
    protected async queryUser(username?: string, password?: string, email?: string, pessoa?: string, tipoPessoa?: TipoPessoa | undefined, active?: boolean, id?: string): Promise<User> {
        try{
